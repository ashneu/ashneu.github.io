...
function changeColor() {
	var red = document.querySelector('#red').value = x;
	var green = document.querySelector('#green').value = y;
	var blue = document.querySelector('#blue').value = z;
	var x = red;
	var y = green;
	var z = blue;
	document.querySelector(colorStr) = 'rgb('x' + 'y' + 'z')';
